...
class Server:
    ...
    def recv_seqA_send_seqB(self):
        ...
        sha_key_string = "bobby".encode()+self.k1
    ...
    def receive_data(self,seqA,seqB, encryption_key, integrity_key):
        ...
        while True:
            ...
            msg = self.get_decrypted_msg(self.socket.recv(64),"bobby".encode()+encryption_key+self.int_to_bytes(seqA,32),integrity_key+self.int_to_bytes(seqA,32))
    ...
    def get_command(self,msg,seqA,seqB, encryption_key, integrity_key):
        ...
        msg = self.get_decrypted_msg(msg,"bobby".encode()+encryption_key+self.int_to_bytes(seqA,32), integrity_key+self.int_to_bytes(seqA,32))
    ...
    def send_command(self,command,seqA,seqB, encryption_key, integrity_key):
        ...
        if command == "End":
            ...
            msg = self.get_decrypted_msg(recv_msg,"bobby".encode()+encryption_key+self.int_to_bytes(seqA,32),integrity_key+self.int_to_bytes(seqA,32))
...
if __name__ == '__main__':
    ...
    s.listen(10)
    f_pubk = open(r"C:\\Users\\vismay\Desktop\sfta\\private_key.pem", 'rb')
...
while True:
    ...
    print(file_name)
    f= open(r"C:\\Users\\vismay\Desktop\\KANYE_2024_LEAK"+file_name,'wb')
    l = 1
    while (l):       
